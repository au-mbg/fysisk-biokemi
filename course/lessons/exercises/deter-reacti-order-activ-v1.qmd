...
The function makes the same fits that you made, but makes them all at once and 
...
The function 'make_plot' is beyond what is expected for this course, however if you are 
interested you can see the source code for it on [github](https://github.com/au-mbg/fysisk-biokemi/blob/main/course-utils/src/fysisk_biokemi/utils/deter_reacti_order_activ.py).
