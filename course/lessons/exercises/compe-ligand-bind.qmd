...
#| eval: false
"""
1. The competitor concentration is zero, so only the ligand L binds. 

2. The affinity and concentration of C is higher so it binds more. 

3. The affinity and concentration of L and C are equal and they both bind equally. 
