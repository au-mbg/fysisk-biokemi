...
Next, we will explore the regime where $[S] \gg K_M$. Initially, set $K_M = 10$ and zoom in on the regime from $0$ to $1$ on the X-axis. What does the MM equation look like in this regime? Use the MM equation and a simplifying assumption to show how this occurs. 
