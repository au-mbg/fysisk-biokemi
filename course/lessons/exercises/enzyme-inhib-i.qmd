...
where $[\text{I}] = 2.5 \times 10^{-3}$ M is the inhibitor concentration, and $K_M^{\text{app}}$ is 
the value we obtained by fitting the data with the inhibitor and $K_M$ is the value we obtained by fitting without. 
