---
title: "Proteins in blood plasma"
categories: ['calculation', 'data']
topics: []
datasets: ['proteins_blood_plasma']
---
...
Use the widget to load the dataset as a dataframe from the file **week47_3_protein_blood_plasma.xlsx**
