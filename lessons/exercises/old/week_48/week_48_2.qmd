---
title: "Determination of type and strength of cooperativity"
categories: ['data', 'plotting', 'regression']
topics: []
datasets: ['determination_coop_week48']
---
...
equilibrium dialysis. The enzyme concentration was 71 μM. The concentration of $[\text{NAD}^{+}_\text{free}]$ and the corresponding values of $\bar{n}$ were determined with the resulting data found in the dataset `week48_2_determination_coop.xlsx`.
...
The function `np.concatenate` takes a number of arrays and makes a new array that 
consisting of the originals one after each other. For example, 
